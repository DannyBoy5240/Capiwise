  ...
  return (
    <div className="bg-[#0B1620] text-white text-xs flex flex-col p-4 h-full text-xs">
      ...
      <div className="grow flex flex-col">
        {/* Content */}
        <div className="gorw items-center flex py-2 border-b border-b-[#252A2D]">
        ...
        <div className="gorw items-center flex py-3 border-b border-b-[#252A2D]">
        ...
        <div className="gorw items-center flex py-3">
          <div className="w-1/3 font-bold">
            Distribution Yield
            <div className="text-[10px] font-normal">(TTM)</div>
          </div>
          <div className="w-1/3 text-right">0.55%</div>
          <div className="w-1/3 text-right">1.19%</div>
        </div>
      </div>
      <div className="pt-2 text-[10px] text-[#979797]">As of 02/28/2023</div>
    </div>
  );
};
