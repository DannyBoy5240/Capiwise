      ...
      <div className="grow flex py-2">
        <div className="flex flex-col w-full">
          ...
          <div className="flex justify-center font-bold">
            <div className="px-4 py-1 border-b-2 border-transparent hover:border-b-[#2EBD85] hover:text-[#2EBD85] hover:cursor-pointer">
              1 Year
            </div>
            <div className="px-4 py-1 border-b-2 border-transparent hover:border-b-[#2EBD85] hover:text-[#2EBD85] hover:cursor-pointer">
              3 Year
          ...
          <div className="border-t border-t-[#252A2D] flex justify-center">
            <div className="px-4 my-2">
              ...
              <div className="text-lg">
                64,149<span className="text-xs">s</span>
              </div>
            </div>
            <div className="px-4 my-2 border-l-2 border-l-[#979797] border-r-2 border-[#979797]">
              ...
              <div className="text-lg">
                48,892<span className="text-xs">s</span>
              </div>
            </div>
            <div className="px-4 my-2">
              <div className="flex items-center">
              ...
              <div className="text-lg">
                40,249<span className="text-xs">s</span>
              </div>
            </div>
          </div>
        </div>
