          ...
          <div className="w-3/5 text-center flex flex-col items-center">
            ...
            <div>
              ...
              <div className="text-sm flex py-2">
                ...
                <div className="mx-1 border-b">Sign Up</div>
              </div>
            </div>
            {/*  */}
            <div className="w-full">
              <div className="text-left">
                ...
                <div className="border-[#979797] border rounded-md px-2 h-9">
                  <input
                    className="bg-transparent text-white focus:outline-none w-full h-full"
                    type="email"
                  />
                </div>
              </div>
              ...
              <div className="rounded-full h-9 mt-4">
                <div className="w-full bg-[#2EBD85] rounded-full p-1 text-[#040B11] text-sm font-medium">
                  Log in
                </div>
              </div>
            </div>
